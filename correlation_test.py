...
from ellips_parameters import *
displacements = np.load("fitted_six_vct_list.npy")
HoQIs = np.load("HoQI_fitted_six_vct_list.npy")
Q1_1x, Q2_1x = np.load("1xQ1.npy"), np.load("1xQ2.npy")
Q1_2x, Q2_2x = np.load("2xQ1.npy"), np.load("2xQ2.npy")
Q1_3x, Q2_3x = np.load("3xQ1.npy"), np.load("3xQ2.npy")
Q1_1z, Q2_1z = np.load("1zQ1.npy"), np.load("1zQ2.npy")
Q1_2z, Q2_2z = np.load("2zQ1.npy"), np.load("2zQ2.npy")
Q1_3z, Q2_3z = np.load("3zQ1.npy"), np.load("3zQ2.npy")
