...
## User selection: This code allows the user to select which kinds of data they want to make plots of
valid_input = True
...
## Import relevant data: This imports the data from the .npy quickaccess lists that have been generated by coprehensive_dat_extraction_and_saving.py
...
## Q1-Q2 plots: This makes Q1-Q2 circle plots of all the selected data types
...
## Time-series: This makes displacement timeseries of all the selected data types
...
## ASD plots: This makes asd plots of all the selected datatypes, as well as one which contains all 3 if all three are active
...
## Parameter Timeseries: This makes ellipse parameter timeseries plots for all 6 HoQI's
...
## Velocity Data plots: This makes timeseries of the velocities for HoQI's and DOF for all selected data types
