...
# parameters = np.load("Data_Analysis_Part_2\\20_param_timeseries_1x_old_transform.npy")
...
print("parm shape:", parameters.shape)
...
for i, name in enumerate(parameter_names):
    ...
    print("percentiles:", np.percentile(values, [0, 1, 5, 50, 95, 99, 100]))
    print()
