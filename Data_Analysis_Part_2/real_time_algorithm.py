...
for index, Q in enumerate(Q_lijst):
    ...
    Q1_transformed, Q2_transformed = standard_step_window_ellipse_fitting(Q1[:initial_training_size], Q2[:initial_training_size], window_size=windows_size)
    transformed_Q_lijst.append([Q1_transformed, Q2_transformed])
    parameters = parameters_timeseries(Q[0][:initial_training_size], Q[1][:initial_training_size], window_size=windows_size, step_size=windows_size)
    parameters_lijst.append(parameters)

for i in parameters_lijst:
    print(i.shape)
