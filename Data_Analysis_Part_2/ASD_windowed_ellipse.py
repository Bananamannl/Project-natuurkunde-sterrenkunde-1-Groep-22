...
Q1_list = np.load('Data_Analysis_Part_1/3zQ1.npy')[:3000000]
Q2_list = np.load('Data_Analysis_Part_1/3zQ2.npy')[:3000000]

transformed_Q1, transformed_Q2 = transform(Q1_list, Q2_list)

windowed_transformed_Q1, windowed_transformed_Q2 = standard_step_window_ellipse_fitting(Q1_list, Q2_list, window_size=1000)
...
axes[0].set_title('ASD diagram for the raw data (1z)')
...
axes[1].set_title('ASD diagram for the transformed data (1z)')
...
axes[2].set_title('ASD diagram for the windowed transformed data (1z)')
