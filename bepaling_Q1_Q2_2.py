...
def Q_lijst():
    ...
    Q_lijst = [Q1_1x, Q2_1x, Q1_2x, Q2_2x, Q1_3x, Q2_3x, Q1_1z, Q2_1z, Q1_2z, Q2_2z, Q1_3z, Q2_3z]
    return Q_lijst
...
Q1_1z, Q2_1z = bepaling_Q1_Q2(PD1_1z, PD2_1z, PD3_1z)
Q1_1z_kopie = Q1_1z.copy()
Q2_1z_kopie = Q2_1z.copy()
np.save("1zQ1.npy", Q1_1z_kopie)
np.save("1zQ2.npy", Q2_1z_kopie)

Q1_2z, Q2_2z = bepaling_Q1_Q2(PD1_2z, PD2_2z, PD3_2z)
Q1_2z_kopie = Q1_2z.copy()
Q2_2z_kopie = Q2_2z.copy()
np.save("2zQ1.npy", Q1_2z_kopie)
np.save("2zQ2.npy", Q2_2z_kopie)

Q1_3z, Q2_3z = bepaling_Q1_Q2(PD1_3z, PD2_3z, PD3_3z)
Q1_3z_kopie = Q1_3z.copy()
Q2_3z_kopie = Q2_3z.copy()
np.save("3zQ1.npy", Q1_3z_kopie)
np.save("3zQ2.npy", Q2_3z_kopie)